...
class Categories extends Component{
    ...
    <li className='sidebar-item' value="Contact Tracing">
        <a href='#' className='sidebar-link'>
          <i className={this.props.icons}  onClick = {(e)=>this.props.change(e,this.props.index)} style={{color:`${this.props.category[this.props.index].color}`,textShadow:"0 0 black"}} />
      ...
      return(
        <li className='sidebar-item' value="Contact Tracing">
            <a href='#' className='sidebar-link'>
              <i className={this.props.icons} onClick = {(e)=>this.props.change(e,this.props.index)} />
